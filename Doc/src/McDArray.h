/***************************************************************
 *
 * $Id: McDArray.h 2216 2008-06-13 21:13:47Z distler $
 *
 * $Log: not supported by cvs2svn $
 * Revision 1.2  1997/08/01 17:46:30  distler
 * ultrix + warning patch
 *
 * Revision 1.1.1.1  1997/07/31 21:52:40  distler
 * Doc++ 3.0 sources
 *
...
{
  int i = array.size()-1;
  for ( ; i>=0; i--) if (array[i] == elem) return i;
  return i;
}
